...
class scan_data(object):
    ...
    def build_contour_data(self):
        ...
        if self.scan_type=='H':
            ...
            # self.contour_interp=RectBivariateSpline(self.htune_scan,self.vtune_scan,self.combined_data.T)
            self.contour_interp=RegularGridInterpolator((self.htune_scan,self.vtune_scan),self.combined_data)
        ...
        if self.scan_type=='V':
            ...
            # self.contour_interp=RectBivariateSpline(self.htune_scan,self.vtune_scan,self.combined_data)
            self.contour_interp=RegularGridInterpolator((self.htune_scan,self.vtune_scan),self.combined_data.T)
    ...
    def build_intensity_data(self,size):
        ...
        # self.contour_interp=RectBivariateSpline(turns,self.vtune_scan,self.combined_data.T)
        self.contour_interp=RegularGridInterpolator(turns,self.vtune_scan,self.combined_data.T)
